...
import { BarChart3, FileText, Mail, Pin, Plus, Route, Trash2, Trophy, UserMinus, Wrench } from '@lucide/vue'
...
<template>
  <div class="mx-auto max-w-4xl px-4 py-12">
    ...
    <div class="mb-10 grid gap-4 sm:grid-cols-2">
      ...
      <NuxtLink :to="localePath('/achievements')">
        <Card class="h-full transition-colors hover:border-primary/50 hover:bg-muted/40">
          <CardHeader>
            <CardTitle class="flex items-center gap-2 text-base">
              <Trophy class="size-4" /> {{ t('achievements.title') }}
            </CardTitle>
            <CardDescription>{{ t('achievements.cardHint') }}</CardDescription>
          </CardHeader>
        </Card>
      </NuxtLink>
