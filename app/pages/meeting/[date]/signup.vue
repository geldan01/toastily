...
import { CalendarDays, UserPlus, X } from '@lucide/vue'
...
// Checked-in guests (PRD §9): pick source for the assign panels below, so a
...
useHead(() => ({ title: `${t('meetings.signupTitle')}${theme.value ? ` — ${theme.value}` : ''}` }))
</script>
